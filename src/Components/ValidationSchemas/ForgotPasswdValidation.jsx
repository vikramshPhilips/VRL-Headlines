...
const ForgotPasswdValidation = Yup.object({
   ...
   "Passwd":Yup.string().min(6,"Password Must at least have 6 char").max(15,"Password at most have 15 character").required("Please Enter the Psssword").matches(/[0-9]/,props("Numeric")).matches(/[a-z]/,props("Lowercase Letter")).matches(/[A-Z]/,props("Uppercase Letter")).matches(/[@,$,#,!,%,*,?,&,-,_,+,=,^,:,;,",']/,props("Special Symbol")),
